...
(function () {
  ...
  function getSidebarContainer() {
    return document.querySelector('#sidebarNav nav, .sidebar nav')
      || document.querySelector('#sidebarNav, .sidebar');
  }
  ...
  function ensureExperienceThemeStyle() {
    ...
    style.textContent = [
      ...
      ':root[data-exp-country] .marketing-card h2{color:var(--rr-exp-primary) !important;}',
  ...
  async function syncNavPlan() {
    ...
    const cachedExperienceContext = {
      ...
      showJamaicaHub: readCachedExperienceCountry() === 'JM',
      requiresChoice: false,
      supportedCountries: [
        { code: 'GLOBAL', label: 'Global' },
        { code: 'JM', label: 'Jamaica' },
